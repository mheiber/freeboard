...
#ifndef FREEBOARD_SWIFT_H
#define FREEBOARD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Freeboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Freeboard11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC9Freeboard30ClipboardHistoryViewController")
@interface ClipboardHistoryViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate>
- (void)loadView;
- (void)viewDidLoad;
- (void)viewDidAppear;
...
SWIFT_CLASS("_TtC9Freeboard11PopupWindow")
...
SWIFT_CLASS("_TtC9Freeboard16RetroEffectsView")
@interface RetroEffectsView : NSView
